...
declare namespace CloudflareWorkersModule {
  ...
  > implements Rpc.WorkerEntrypointBranded
  {
    ...
    tailStream?(event: TailStream.TailEvent<TailStream.Onset>): TailStream.TailEventHandlerType | Promise<TailStream.TailEventHandlerType> | undefined | Promise<undefined>;
